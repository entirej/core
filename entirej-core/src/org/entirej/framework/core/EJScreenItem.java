...
public class EJScreenItem
{
    ...
    public void setValue(Object value)
    {
        if (value != null)
        {
            ...
            {
                throw new EJApplicationException(EJMessageFactory.getInstance().createMessage(EJFrameworkMessage.INVALID_DATA_TYPE_FOR_ITEM, itemProperties.getName(), itemProperties.getDataTypeClassName(), value.getClass().getName()));
            }
        }
    ...
    public List<Object>  getValidValues()
    {
        if (_item.getManagedItemRenderer() != null)
        {
            return _item.getManagedItemRenderer().getValidValues();
        }
        else
        {
            return null;
    ...
    {
        EJFrameworkExtensionProperties blockRendererRequiredProperties = ((EJCoreMainScreenItemProperties) _item.getProperties()).getBlockRendererRequiredProperties();
