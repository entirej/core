...
public class EJCoreInsertScreenItemPropertiesHandler extends EJCorePropertiesTagHandler
{
    private EJCorePropertiesHandlerFactory   _handlerFactory;
    private EJCoreInsertScreenItemProperties _itemProperties;
    private EJCoreFormProperties             _formProperties;
    private EJCoreBlockProperties            _blockProperties;
    private static final String              ELEMENT_INSERT_SCREEN_RENDERER_PROPERTIES = "insertScreenRendererItemProperties";
    ...
    public EJCoreInsertScreenItemPropertiesHandler(EJCorePropertiesHandlerFactory handlerFactory, EJCoreBlockProperties blockProperties)
    {
        _handlerFactory = handlerFactory;
        _formProperties = blockProperties.getFormProperties();
        _blockProperties = blockProperties;
        _itemProperties = new EJCoreInsertScreenItemProperties(blockProperties, false);
    }
    
    public EJCoreInsertScreenItemProperties getItemProperties()
    {
    ...
    public void startLocalElement(String name, Attributes attributes) throws SAXException
    {
        ...
        else if (name.equals(ELEMENT_INSERT_SCREEN_RENDERER_PROPERTIES))
        {
            ...
            // properties
            setDelegate(_handlerFactory.createFrameworkExtensionPropertiesHandler(_formProperties, _blockProperties, ELEMENT_INSERT_SCREEN_RENDERER_PROPERTIES));
        }
    }
    ...
    public void endLocalElement(String name, String value, String untrimmedValue)
    {
        ...
        else if (name.equals(ELEMENT_LOV_MAPPING_NAME))
        {
            if (value.length() > 0)
            {
                ...
                _itemProperties.getReferencedItemProperties().setLovMappingNameOnInsert(value);
            }
        }
    ...
    {
        if (name.equals(ELEMENT_INSERT_SCREEN_RENDERER_PROPERTIES))
        {
            _itemProperties.setInsertScreenRendererProperties(((EJCoreFrameworkExtensionPropertiesHandler) currentDelegate).getMainPropertiesGroup());
        }
    }
