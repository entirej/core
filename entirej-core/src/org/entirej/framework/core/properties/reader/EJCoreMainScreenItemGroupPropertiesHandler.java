...
public class EJCoreMainScreenItemGroupPropertiesHandler extends EJCoreItemGroupPropertiesHandler
{
    private EJCorePropertiesHandlerFactory        _handlerFactory;
    private EJCoreMainScreenItemPropertiesHandler _itemHandler;
    private EJCoreBlockProperties                 _blockProperties;
    
    public EJCoreMainScreenItemGroupPropertiesHandler(EJCorePropertiesHandlerFactory handlerFactory, EJCoreBlockProperties blockProperties,
    ...
    {
        _itemHandler = _handlerFactory.createMainScreenItemHandler(_blockProperties);
    ...
    {
        return _handlerFactory.createMainScreenItemGroupHandler(_blockProperties, itemGroup.getChildItemGroupContainer(), "itemGroupList");
    }
}
