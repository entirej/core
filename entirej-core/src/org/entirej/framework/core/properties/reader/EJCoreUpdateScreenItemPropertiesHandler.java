...
public class EJCoreUpdateScreenItemPropertiesHandler extends EJCorePropertiesTagHandler
{
    private EJCoreUpdateScreenItemProperties _itemProperties;
    ...
    private static final String              ELEMENT_UPDATE_SCREEN_RENDERER_PROPERTIES = "updateScreenRendererItemProperties";
    ...
    public EJCoreUpdateScreenItemPropertiesHandler(EJCorePropertiesHandlerFactory handlerFactory, EJCoreBlockProperties blockProperties)
    {
        _blockProperties = blockProperties;
        _handlerFactory = handlerFactory;
        _formProperties = blockProperties.getFormProperties();
        _itemProperties = new EJCoreUpdateScreenItemProperties(blockProperties, false);
    }
    
    public EJCoreUpdateScreenItemProperties getItemProperties()
    {
    ...
    public void startLocalElement(String name, Attributes attributes) throws SAXException
    {
        ...
        else if (name.equals(ELEMENT_UPDATE_SCREEN_RENDERER_PROPERTIES))
        {
            ...
            // properties
            setDelegate(_handlerFactory.createFrameworkExtensionPropertiesHandler(_formProperties, _blockProperties, ELEMENT_UPDATE_SCREEN_RENDERER_PROPERTIES));
        }
    }
    ...
    public void endLocalElement(String name, String value, String untrimmedValue)
    {
        ...
        else if (name.equals(ELEMENT_LOV_MAPPING_NAME))
        {
            if (value.length() > 0)
            {
                ...
                _itemProperties.getReferencedItemProperties().setLovMappingNameOnUpdate(value);
            }
        }
    ...
    {
        if (name.equals(ELEMENT_UPDATE_SCREEN_RENDERER_PROPERTIES))
        {
            _itemProperties.setUpdateScreenRendererProperties(((EJCoreFrameworkExtensionPropertiesHandler) currentDelegate).getMainPropertiesGroup());
        }
    }
}
