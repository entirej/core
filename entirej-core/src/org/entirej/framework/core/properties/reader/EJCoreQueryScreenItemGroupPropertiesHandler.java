...
public class EJCoreQueryScreenItemGroupPropertiesHandler extends EJCoreItemGroupPropertiesHandler
{
    private EJCorePropertiesHandlerFactory         _handlerFactory;
    private EJCoreQueryScreenItemPropertiesHandler _itemHandler;
    private EJCoreBlockProperties                  _blockProperties;
    
    public EJCoreQueryScreenItemGroupPropertiesHandler(EJCorePropertiesHandlerFactory handlerFactory, EJCoreBlockProperties blockProperties,
    ...
    {
        _itemHandler = _handlerFactory.createQueryScreenItemHandler(_blockProperties);
    ...
    {
        return _handlerFactory.createQueryScreenItemGroupHandler(_blockProperties, itemGroup.getChildItemGroupContainer(), "itemGroupList");
    }
}
