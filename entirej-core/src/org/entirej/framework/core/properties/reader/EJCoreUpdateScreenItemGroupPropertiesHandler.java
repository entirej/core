...
public class EJCoreUpdateScreenItemGroupPropertiesHandler extends EJCoreItemGroupPropertiesHandler
{
    private EJCorePropertiesHandlerFactory          _handlerFactory;
    private EJCoreUpdateScreenItemPropertiesHandler _itemHandler;
    private EJCoreBlockProperties                   _blockProperties;
    
    public EJCoreUpdateScreenItemGroupPropertiesHandler(EJCorePropertiesHandlerFactory handlerFactory, EJCoreBlockProperties blockProperties,
    ...
    {
        _itemHandler = _handlerFactory.createUpdateScreenItemHandler(_blockProperties);
    ...
    {
        return _handlerFactory.createUpdateScreenItemGroupHandler(_blockProperties, itemGroup.getChildItemGroupContainer(), "itemGroupList");
    }
}
