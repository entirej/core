...
public class EJCoreInsertScreenItemProperties implements EJScreenItemProperties, EJInsertScreenItemProperties
{
     ...
     *             if the given item name does not exist within the block to
     *             which this insert screen belongs
     */
    public void setReferencedItemName(String name)
    {
        ...
        if (!_isSpacerItem)
        {
            ...
            {
                throw new EJApplicationException(EJMessageFactory.getInstance().createMessage(EJFrameworkMessage.INVALID_SCREEN_ITEM_REFERENCE, "insert",
     ...
     * 
     * @param properties
     *            The required blocks insert screen renderer properties
     */
    public void setInsertScreenRendererProperties(EJFrameworkExtensionProperties properties)
    {
     ...
     * <p>
     * If an lov mapping was assigned, the item will respond to the user opening
     ...
     *            The name of the lov mapping to be assigned to this item
     */
