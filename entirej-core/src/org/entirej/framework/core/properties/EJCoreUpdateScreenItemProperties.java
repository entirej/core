...
import org.entirej.framework.core.properties.interfaces.EJUpdateScreenItemProperties;
 ...
 * Y coordinates.
 */
public class EJCoreUpdateScreenItemProperties implements EJScreenItemProperties, EJUpdateScreenItemProperties
{
    ...
    public EJCoreUpdateScreenItemProperties(EJCoreBlockProperties blockProperties, boolean isSpacer)
    {
     ...
     *             if there is no item with the given name on the block to which
     *             this update screen belongs
     */
    public void setReferencedItemName(String name)
    {
        ...
        if (!_isSpacerItem)
        {
            ...
            {
                throw new EJApplicationException(EJMessageFactory.getInstance().createMessage(EJFrameworkMessage.INVALID_SCREEN_ITEM_REFERENCE, "update",
    ...
    /**
     * Returns the <code>ItemProperties</code> to which this update screen item
     * references
     * 
     ...
     * blocks update screen renderer
     * 
     * @return The required blocks update screen renderer properties
     */
     ...
     * 
     * @param properties
     *            The required blocks update screen renderer properties
     */
    public void setUpdateScreenRendererProperties(EJFrameworkExtensionProperties properties)
    {
        _updateScreenRendererProperties = properties;
    }
