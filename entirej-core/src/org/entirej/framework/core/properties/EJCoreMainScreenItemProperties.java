...
/**
 * Contains the properties required for the main screen if the block renderer is
 * a GridLayoutRenderer
 */
public class EJCoreMainScreenItemProperties implements EJScreenItemProperties
{
    ...
    private EJCoreVisualAttributeProperties _visualAttribute       = null;

    public EJCoreMainScreenItemProperties(EJCoreBlockProperties blockProperties, boolean spacerItem)
    {
        _blockProperties = blockProperties;
        _isSpacerItem = spacerItem;
    }
     ...
     *             if there is no item with the given name within the block to
     *             which this main screen belongs
     */
    public void setReferencedItemName(String name)
    {
        ...
        if (!_isSpacerItem)
        {
            ...
            {
                throw new EJApplicationException(EJMessageFactory.getInstance().createMessage(EJFrameworkMessage.INVALID_SCREEN_ITEM_REFERENCE, "main",
    ...
    /**
     * Returns the <code>ItemProperties</code> to which this main screen item
     * references
     * 
    ...
    /**
     * Sets the <code>RenderingProperties</code> that are required by the block
     * renderer
     * 
     * @param properties
     *            The required block renderer properties for this item
     */
    ...
    /**
     * Returns the <code>RenderingProperties</code> that are required by the lov
     * renderer
     * 
     * @return The required lov renderer properties for this item
     */
    ...
    /**
     * Sets the <code>RenderingProperties</code> that are required by the lov
     * renderer
     * 
     * @param properties
     *            The required lov renderer properties for this item
     */
