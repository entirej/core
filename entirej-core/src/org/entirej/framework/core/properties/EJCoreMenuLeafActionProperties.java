...
public class EJCoreMenuLeafActionProperties extends EJCoreMenuLeafProperties implements Serializable
{
    private String _menuAction;
    private String _hint;
    private String _baseHint;
    
    public EJCoreMenuLeafActionProperties(EJCoreMenuProperties menu, EJCoreMenuLeafContainer container)
    {
