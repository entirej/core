...
public class EJUpdateScreenItemRendererRegister extends EJBlockItemRendererRegister
{
    ...
    public void resetRegister()
    {
        ...
        {
            EJScreenItemController item = getBlockController().getScreenItem(EJScreenType.UPDATE, wrapper.getRegisteredItemName());
     ...
     * <code>UpdateScreenItemProperties</code> values
     * 
     */
    public void initialiseRegisteredRenderers()
    {
        Iterator<EJItemGroupProperties> itemGroups = getBlockController().getProperties().getScreenItemGroupContainer(EJScreenType.UPDATE)
    ...
    {
        super.enableItem(EJScreenType.UPDATE, itemProps);
    }
    ...
    {
        super.setItemValueNoValidate(EJScreenType.UPDATE, itemName, value);
    }
    ...
    {
        super.setItemValue(EJScreenType.UPDATE, itemName, value);
    }
    
    /**
     * Registers a given renderer for the specified item
     * <p>
     * Once an item has its renderer registered then all synchronisation between
