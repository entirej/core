...
public class EJQueryScreenItemRendererRegister extends EJBlockItemRendererRegister
{
    ...
    public void resetRegister()
    {
        ...
        {
            EJScreenItemController item = getBlockController().getScreenItem(EJScreenType.QUERY, wrapper.getRegisteredItemName());
     ...
     * <code>QueryScreenItemProperties</code> values
     * 
     */
    public void initialiseRegisteredRenderers()
    {
        Iterator<EJItemGroupProperties> itemGroups = getBlockController().getProperties().getScreenItemGroupContainer(EJScreenType.QUERY)
                .getAllItemGroupProperties().iterator();
        while (itemGroups.hasNext())
        {
            for (EJScreenItemProperties itemProperties : itemGroups.next().getAllItemProperties())
            {
                if (itemProperties.isVisible())
                {
    ...
    {
        super.enableItem(EJScreenType.QUERY, itemProps);
    }
     ...
     * 
     * @param itemName
     *            The name of the item for which the value will be set
     * @param value
     *            The value to set
    ...
    {
        super.setItemValueNoValidate(EJScreenType.QUERY, itemName, value);
    }
    ...
    {
        super.setItemValue(EJScreenType.QUERY, itemName, value);
    }
