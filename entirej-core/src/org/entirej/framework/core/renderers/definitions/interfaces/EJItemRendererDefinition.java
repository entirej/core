...
public interface EJItemRendererDefinition extends EJRendererDefinition
{
    /**
    ...
    /**
     * Indicates if this item renderer can execute an Action Command
     * <p>
     * Action commands are normally executed by buttons, check boxes etc.
     * 
     * @return <code>true</code> if action commands are executed by the
     *         renderer, otherwise <code>false</code>
     */
    public boolean canExecuteActionCommand();
    
    /**
     * Indicates if this item renderer is read-only
     * 
