...
public interface EJUpdateScreenRendererDefinition extends EJRendererDefinition
{
    /**
    ...
    /**
     * Returns the renderer properties that are defined for the update screen
     * <p>
     ...
     * <code>EJUpdateScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions defined for the update screen or
     ...
     * item contained within the update screen
     * <p>
     * The <code>EJPropertyDefinitionGroup</code> returned by this method will
     * be used by the <b>EntireJ Framework Plugin</code> to display a list of
     * properties to the user. These values will then be saved to the form
     * definition file and later made available to the
     * <code>WJUpdateScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions for the update screen items or
    ...
    /**
     * Returns the renderer properties that can be entered by the users for each
     * spacer item contained within the update screen
     * <p>
     * The <code>EJPropertyDefinitionGroup</code> returned by this method will
     * be used by the <b>EntireJ Framework Plugin</code> to display a list of
     * properties to the user. These values will then be saved to the form
     ...
     * <code>EJUpdateScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions for the update screen spacer items or
     *         <code>null</code> if no properties are defined
     */
