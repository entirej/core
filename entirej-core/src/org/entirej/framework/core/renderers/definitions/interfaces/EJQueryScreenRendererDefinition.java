...
public interface EJQueryScreenRendererDefinition extends EJRendererDefinition
{
    /**
    ...
    /**
     * Returns the renderer properties that are defined for the query screen
     * <p>
     ...
     * <code>EJQueryScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions defined for the query screen or
     ...
     * item contained within the query screen
     * <p>
     * The <code>EJPropertyDefinitionGroup</code> returned by this method will
     * be used by the <b>EntireJ Framework Plugin</code> to display a list of
     * properties to the user. These values will then be saved to the form
     ...
     * <code>EJQueryScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions for the query screen items or
    ...
    /**
     * Returns the renderer properties that can be entered by the users for each
     * spacer item contained within the query screen
     * <p>
     * The <code>EJPropertyDefinitionGroup</code> returned by this method will
     * be used by the <b>EntireJ Framework Plugin</code> to display a list of
     * properties to the user. These values will then be saved to the form
     ...
     * <code>EJQueryScreenRenderer</code> by the <b>EntireJ Framework</b>
     * 
     * @return The property definitions for the query screen spacer items or
     *         <code>null</code> if no properties are defined
     */
